 ...
 * 
 * <p>ADDITIONAL-BINDING-TIME-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="ADDITIONAL-BINDING-TIME-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>ADDITIONAL-BINDING-TIME-ENUM--SIMPLE">
...
@XmlType(name = "ADDITIONAL-BINDING-TIME-ENUM", propOrder = {
    "value"
})
public class ADDITIONALBINDINGTIMEENUM {
     ...
     * @return
     *     possible object is
     *     {@link ADDITIONALBINDINGTIMEENUMSIMPLE }
     *     
     */
