 ...
 * 
 * <p>DIAGNOSTIC-VALUE-ACCESS-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAGNOSTIC-VALUE-ACCESS-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>DIAGNOSTIC-VALUE-ACCESS-ENUM--SIMPLE">
...
@XmlType(name = "DIAGNOSTIC-VALUE-ACCESS-ENUM", propOrder = {
    "value"
})
public class DIAGNOSTICVALUEACCESSENUM {
     ...
     * @return
     *     possible object is
     *     {@link DIAGNOSTICVALUEACCESSENUMSIMPLE }
     *     
     */
