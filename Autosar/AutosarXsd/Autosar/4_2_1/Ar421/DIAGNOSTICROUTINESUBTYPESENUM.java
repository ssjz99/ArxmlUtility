...
/**
 * <p>DIAGNOSTIC-ROUTINE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-ROUTINE--SUBTYPES-ENUM">
...
public enum DIAGNOSTICROUTINESUBTYPESENUM {
    ...
    DIAGNOSTICROUTINESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICROUTINESUBTYPESENUM fromValue(String v) {
