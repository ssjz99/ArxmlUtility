...
/**
 * <p>SOCKET-ADDRESS--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="SOCKET-ADDRESS--SUBTYPES-ENUM">
...
public enum SOCKETADDRESSSUBTYPESENUM {
    ...
    SOCKETADDRESSSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static SOCKETADDRESSSUBTYPESENUM fromValue(String v) {
