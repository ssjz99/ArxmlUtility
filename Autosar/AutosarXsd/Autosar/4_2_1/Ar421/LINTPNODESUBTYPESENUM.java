...
/**
 * <p>LIN-TP-NODE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="LIN-TP-NODE--SUBTYPES-ENUM">
...
public enum LINTPNODESUBTYPESENUM {
    ...
    LINTPNODESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static LINTPNODESUBTYPESENUM fromValue(String v) {
