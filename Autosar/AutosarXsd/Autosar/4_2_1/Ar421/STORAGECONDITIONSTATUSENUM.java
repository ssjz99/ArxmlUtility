 ...
 * 
 * <p>STORAGE-CONDITION-STATUS-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="STORAGE-CONDITION-STATUS-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>STORAGE-CONDITION-STATUS-ENUM--SIMPLE">
...
@XmlType(name = "STORAGE-CONDITION-STATUS-ENUM", propOrder = {
    "value"
})
public class STORAGECONDITIONSTATUSENUM {
     ...
     * @return
     *     possible object is
     *     {@link STORAGECONDITIONSTATUSENUMSIMPLE }
     *     
     */
