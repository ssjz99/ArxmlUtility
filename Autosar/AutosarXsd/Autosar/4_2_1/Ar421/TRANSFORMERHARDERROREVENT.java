...
/**
 * The event is raised when data are received which should trigger a Client/Server operation but during transformation of the data a hard transformer error occurred.
 * 
 * <p>TRANSFORMER-HARD-ERROR-EVENT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="TRANSFORMER-HARD-ERROR-EVENT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}TRANSFORMER-HARD-ERROR-EVENT"/>
 *       &lt;/sequence>
...
@XmlType(name = "TRANSFORMER-HARD-ERROR-EVENT", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
