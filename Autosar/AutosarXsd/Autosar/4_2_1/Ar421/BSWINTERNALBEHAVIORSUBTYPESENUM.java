...
/**
 * <p>BSW-INTERNAL-BEHAVIOR--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="BSW-INTERNAL-BEHAVIOR--SUBTYPES-ENUM">
...
public enum BSWINTERNALBEHAVIORSUBTYPESENUM {
    ...
    BSWINTERNALBEHAVIORSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static BSWINTERNALBEHAVIORSUBTYPESENUM fromValue(String v) {
