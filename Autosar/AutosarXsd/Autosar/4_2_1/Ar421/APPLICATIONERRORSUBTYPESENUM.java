...
/**
 * <p>APPLICATION-ERROR--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="APPLICATION-ERROR--SUBTYPES-ENUM">
...
public enum APPLICATIONERRORSUBTYPESENUM {
    ...
    APPLICATIONERRORSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static APPLICATIONERRORSUBTYPESENUM fromValue(String v) {
