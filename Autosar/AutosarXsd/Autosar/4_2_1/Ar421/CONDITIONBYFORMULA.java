 ...
 * 
 * <p>CONDITION-BY-FORMULA complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="CONDITION-BY-FORMULA">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}CONDITION-BY-FORMULA"/>
 *       &lt;/choice>
 *       &lt;attGroup ref="{http://autosar.org/schema/r4.0}CONDITION-BY-FORMULA"/>
...
@XmlType(name = "CONDITION-BY-FORMULA", propOrder = {
    "content"
})
public class CONDITIONBYFORMULA {
     ...
     * * "0" represents "false";  
     * 
     * * a value other than zero is considered "true"Gets the value of the content property.
     * 
     * <p>
