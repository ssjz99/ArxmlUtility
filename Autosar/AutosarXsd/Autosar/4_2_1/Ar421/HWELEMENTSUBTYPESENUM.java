...
/**
 * <p>HW-ELEMENT--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="HW-ELEMENT--SUBTYPES-ENUM">
...
public enum HWELEMENTSUBTYPESENUM {
    ...
    HWELEMENTSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static HWELEMENTSUBTYPESENUM fromValue(String v) {
