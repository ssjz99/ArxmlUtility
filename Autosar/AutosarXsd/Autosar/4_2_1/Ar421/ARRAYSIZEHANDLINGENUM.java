 ...
 * 
 * <p>ARRAY-SIZE-HANDLING-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="ARRAY-SIZE-HANDLING-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>ARRAY-SIZE-HANDLING-ENUM--SIMPLE">
...
@XmlType(name = "ARRAY-SIZE-HANDLING-ENUM", propOrder = {
    "value"
})
public class ARRAYSIZEHANDLINGENUM {
     ...
     * @return
     *     possible object is
     *     {@link ARRAYSIZEHANDLINGENUMSIMPLE }
     *     
     */
