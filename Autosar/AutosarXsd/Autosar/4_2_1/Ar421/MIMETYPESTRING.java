 ...
 * 
 * <p>MIME-TYPE-STRING complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="MIME-TYPE-STRING">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>MIME-TYPE-STRING--SIMPLE">
...
@XmlType(name = "MIME-TYPE-STRING", propOrder = {
    "value"
})
