 ...
 * 
 * <p>TD-EVENT-TT-CAN-CYCLE-START complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="TD-EVENT-TT-CAN-CYCLE-START">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}TD-EVENT-TT-CAN-CYCLE-START"/>
 *       &lt;/sequence>
...
@XmlType(name = "TD-EVENT-TT-CAN-CYCLE-START", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class TDEVENTTTCANCYCLESTART {
    ...
    protected TDEVENTTTCANCYCLESTART.TTCANCLUSTERREF ttcanclusterref;
     ...
     * @return
     *     possible object is
     *     {@link TDEVENTTTCANCYCLESTART.TTCANCLUSTERREF }
     *     
     */
    public TDEVENTTTCANCYCLESTART.TTCANCLUSTERREF getTTCANCLUSTERREF() {
        return ttcanclusterref;
    }
     ...
     *     
     */
    public void setTTCANCLUSTERREF(TDEVENTTTCANCYCLESTART.TTCANCLUSTERREF value) {
     ...
     *       &lt;attribute name="DEST" use="required" type="{http://autosar.org/schema/r4.0}TTCAN-CLUSTER--SUBTYPES-ENUM" />
     *     &lt;/extension>
     *   &lt;/simpleContent>
     * &lt;/complexType>
     * </pre>
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class TTCANCLUSTERREF
        extends REF
    {
