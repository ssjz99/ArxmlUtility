 ...
 * 
 * <p>DATA-SEND-COMPLETED-EVENT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DATA-SEND-COMPLETED-EVENT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DATA-SEND-COMPLETED-EVENT"/>
 *       &lt;/sequence>
...
@XmlType(name = "DATA-SEND-COMPLETED-EVENT", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class DATASENDCOMPLETEDEVENT {
    ...
    protected DATASENDCOMPLETEDEVENT.EVENTSOURCEREF eventsourceref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link DATASENDCOMPLETEDEVENT.EVENTSOURCEREF }
     *     
     */
    public DATASENDCOMPLETEDEVENT.EVENTSOURCEREF getEVENTSOURCEREF() {
     ...
     *     
     */
    public void setEVENTSOURCEREF(DATASENDCOMPLETEDEVENT.EVENTSOURCEREF value) {
