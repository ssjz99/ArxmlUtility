...
/**
 * <p>ECUC-MODULE-DEF--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="ECUC-MODULE-DEF--SUBTYPES-ENUM">
...
public enum ECUCMODULEDEFSUBTYPESENUM {
    ...
    ECUCMODULEDEFSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static ECUCMODULEDEFSUBTYPESENUM fromValue(String v) {
