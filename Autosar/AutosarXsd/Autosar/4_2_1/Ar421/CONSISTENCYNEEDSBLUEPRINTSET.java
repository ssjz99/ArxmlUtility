 ...
 * 
 * <p>CONSISTENCY-NEEDS-BLUEPRINT-SET complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="CONSISTENCY-NEEDS-BLUEPRINT-SET">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}CONSISTENCY-NEEDS-BLUEPRINT-SET"/>
 *       &lt;/sequence>
...
@XmlType(name = "CONSISTENCY-NEEDS-BLUEPRINT-SET", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class CONSISTENCYNEEDSBLUEPRINTSET {
    ...
    protected CONSISTENCYNEEDSBLUEPRINTSET.CONSISTENCYNEEDSS consistencyneedss;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link CONSISTENCYNEEDSBLUEPRINTSET.CONSISTENCYNEEDSS }
     *     
     */
    public CONSISTENCYNEEDSBLUEPRINTSET.CONSISTENCYNEEDSS getCONSISTENCYNEEDSS() {
     ...
     *     
     */
    public void setCONSISTENCYNEEDSS(CONSISTENCYNEEDSBLUEPRINTSET.CONSISTENCYNEEDSS value) {
