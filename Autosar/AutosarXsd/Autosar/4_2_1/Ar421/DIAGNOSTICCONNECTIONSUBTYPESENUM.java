...
/**
 * <p>DIAGNOSTIC-CONNECTION--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-CONNECTION--SUBTYPES-ENUM">
...
public enum DIAGNOSTICCONNECTIONSUBTYPESENUM {
    ...
    DIAGNOSTICCONNECTIONSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICCONNECTIONSUBTYPESENUM fromValue(String v) {
