...
/**
 * <p>DIAGNOSTIC-EVENT--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-EVENT--SUBTYPES-ENUM">
...
public enum DIAGNOSTICEVENTSUBTYPESENUM {
    ...
    DIAGNOSTICEVENTSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICEVENTSUBTYPESENUM fromValue(String v) {
