 ...
 * 
 * <p>DTC-STATUS-CHANGE-NOTIFICATION-NEEDS complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DTC-STATUS-CHANGE-NOTIFICATION-NEEDS">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DTC-STATUS-CHANGE-NOTIFICATION-NEEDS"/>
 *       &lt;/sequence>
...
@XmlType(name = "DTC-STATUS-CHANGE-NOTIFICATION-NEEDS", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class DTCSTATUSCHANGENOTIFICATIONNEEDS {
     ...
     * @return
     *     possible object is
     *     {@link DTCFORMATTYPEENUM }
     *     
     */
    public DTCFORMATTYPEENUM getDTCFORMATTYPE() {
        return dtcformattype;
    }
