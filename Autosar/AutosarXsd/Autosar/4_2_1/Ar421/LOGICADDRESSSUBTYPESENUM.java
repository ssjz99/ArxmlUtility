...
/**
 * <p>LOGIC-ADDRESS--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="LOGIC-ADDRESS--SUBTYPES-ENUM">
...
public enum LOGICADDRESSSUBTYPESENUM {
    ...
    LOGICADDRESSSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static LOGICADDRESSSUBTYPESENUM fromValue(String v) {
