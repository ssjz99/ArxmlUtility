 ...
 * 
 * <p>AREA-ENUM-NOHREF complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="AREA-ENUM-NOHREF">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>AREA-ENUM-NOHREF--SIMPLE">
...
@XmlType(name = "AREA-ENUM-NOHREF", propOrder = {
    "value"
})
