...
public class COMPUT_SCALES_COMPLEX {

    @XmlElement(name = "COMPU-SCALES")
    protected COMPUT_SCALES_COMPLEX.COMPUSCALES compuscales;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link COMPUT_SCALES_COMPLEX.COMPUSCALES }
     *     
     */
    public COMPUT_SCALES_COMPLEX.COMPUSCALES getCOMPUSCALES() {
        return compuscales;
    }
     ...
     *     
     */
    public void setCOMPUSCALES(COMPUT_SCALES_COMPLEX.COMPUSCALES value) {
