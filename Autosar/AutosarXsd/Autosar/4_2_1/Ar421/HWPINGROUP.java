 ...
 * 
 * <p>HW-PIN-GROUP complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="HW-PIN-GROUP">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}HW-PIN-GROUP"/>
 *       &lt;/sequence>
...
@XmlType(name = "HW-PIN-GROUP", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class HWPINGROUP {
     ...
     * @return
     *     possible object is
     *     {@link HWPINGROUPCONTENT }
     *     
     */
    public HWPINGROUPCONTENT getHWPINGROUPCONTENT() {
        return hwpingroupcontent;
    }
