 ...
 * 
 * <p>BOOLEAN-VALUE-VARIATION-POINT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="BOOLEAN-VALUE-VARIATION-POINT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}BOOLEAN-VALUE-VARIATION-POINT"/>
 *       &lt;/choice>
...
@XmlType(name = "BOOLEAN-VALUE-VARIATION-POINT", propOrder = {
    "content"
})
public class BOOLEANVALUEVARIATIONPOINT {
     ...
     * This class represents an attribute value variation point for Boolean attributes.
     * 
     * Note that this class might be used in the extended meta-model on Gets the value of the content property.
     * 
     * <p>
