...
/**
 * <p>MODE-DECLARATION--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="MODE-DECLARATION--SUBTYPES-ENUM">
...
public enum MODEDECLARATIONSUBTYPESENUM {
    ...
    MODEDECLARATIONSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static MODEDECLARATIONSUBTYPESENUM fromValue(String v) {
