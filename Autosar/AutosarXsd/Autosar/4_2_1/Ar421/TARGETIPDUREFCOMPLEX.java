...
public class TARGETIPDUREFCOMPLEX {

    @XmlElement(name = "DEFAULT-VALUE")
    protected PDUMAPPINGDEFAULTVALUE defaultvalue;
    @XmlElement(name = "TARGET-I-PDU-REF")
    protected TARGETIPDUREFCOMPLEX.TARGETIPDUREF targetipduref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link TARGETIPDUREFCOMPLEX.TARGETIPDUREF }
     *     
     */
    public TARGETIPDUREFCOMPLEX.TARGETIPDUREF getTARGETIPDUREF() {
     ...
     *     
     */
    public void setTARGETIPDUREF(TARGETIPDUREFCOMPLEX.TARGETIPDUREF value) {
