...
/**
 * <p>ACL-OPERATION--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="ACL-OPERATION--SUBTYPES-ENUM">
...
public enum ACLOPERATIONSUBTYPESENUM {
    ...
    ACLOPERATIONSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static ACLOPERATIONSUBTYPESENUM fromValue(String v) {
