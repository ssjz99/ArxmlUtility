 ...
 * 
 * <p>TRIGGER-INTERFACE complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="TRIGGER-INTERFACE">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}TRIGGER-INTERFACE"/>
 *       &lt;/sequence>
...
@XmlType(name = "TRIGGER-INTERFACE", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class TRIGGERINTERFACE {
    ...
    protected TRIGGERINTERFACE.TRIGGERS triggers;
     ...
     * @return
     *     possible object is
     *     {@link TRIGGERINTERFACE.TRIGGERS }
     *     
     */
    public TRIGGERINTERFACE.TRIGGERS getTRIGGERS() {
        return triggers;
    }
     ...
     *     
     */
    public void setTRIGGERS(TRIGGERINTERFACE.TRIGGERS value) {
        this.triggers = value;
    }
