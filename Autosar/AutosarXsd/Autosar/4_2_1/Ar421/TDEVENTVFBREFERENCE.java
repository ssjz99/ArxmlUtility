 ...
 * 
 * <p>TD-EVENT-VFB-REFERENCE complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="TD-EVENT-VFB-REFERENCE">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}TD-EVENT-VFB-REFERENCE"/>
 *       &lt;/sequence>
...
@XmlType(name = "TD-EVENT-VFB-REFERENCE", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class TDEVENTVFBREFERENCE {
    ...
    protected TDEVENTVFBREFERENCE.REFERENCEDTDEVENTVFBREF referencedtdeventvfbref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link TDEVENTVFBREFERENCE.REFERENCEDTDEVENTVFBREF }
     *     
     */
    public TDEVENTVFBREFERENCE.REFERENCEDTDEVENTVFBREF getREFERENCEDTDEVENTVFBREF() {
        return referencedtdeventvfbref;
    }
     ...
     *     
     */
    public void setREFERENCEDTDEVENTVFBREF(TDEVENTVFBREFERENCE.REFERENCEDTDEVENTVFBREF value) {
     ...
     *       &lt;attribute name="DEST" use="required" type="{http://autosar.org/schema/r4.0}TD-EVENT-VFB--SUBTYPES-ENUM" />
     *     &lt;/extension>
     *   &lt;/simpleContent>
     * &lt;/complexType>
     * </pre>
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class REFERENCEDTDEVENTVFBREF
        extends REF
    {
