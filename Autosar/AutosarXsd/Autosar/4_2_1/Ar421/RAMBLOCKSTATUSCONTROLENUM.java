 ...
 * 
 * <p>RAM-BLOCK-STATUS-CONTROL-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="RAM-BLOCK-STATUS-CONTROL-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>RAM-BLOCK-STATUS-CONTROL-ENUM--SIMPLE">
...
@XmlType(name = "RAM-BLOCK-STATUS-CONTROL-ENUM", propOrder = {
    "value"
})
public class RAMBLOCKSTATUSCONTROLENUM {
     ...
     * @return
     *     possible object is
     *     {@link RAMBLOCKSTATUSCONTROLENUMSIMPLE }
     *     
     */
