 ...
 * 
 * <p>UNIT-GROUP complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}UNIT-GROUP"/>
 *       &lt;/sequence>
...
@XmlType(name = "UNIT-GROUP", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class UNITGROUP {
    ...
    public static class UNITREFS {
        ...
        protected List<UNITGROUP.UNITREFS.UNITREF> unitref;
         ...
         * {@link UNITGROUP.UNITREFS.UNITREF }
         * 
         * 
         */
        public List<UNITGROUP.UNITREFS.UNITREF> getUNITREF() {
            if (unitref == null) {
                unitref = new ArrayList<UNITGROUP.UNITREFS.UNITREF>();
            }
            return this.unitref;
        }
