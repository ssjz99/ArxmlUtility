...
/**
 * <p>DIAGNOSTIC-INDICATOR--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-INDICATOR--SUBTYPES-ENUM">
...
public enum DIAGNOSTICINDICATORSUBTYPESENUM {
    ...
    DIAGNOSTICINDICATORSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICINDICATORSUBTYPESENUM fromValue(String v) {
