 ...
 * 
 * <p>DIAGNOSTIC-WRITE-DATA-BY-IDENTIFIER-CLASS complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAGNOSTIC-WRITE-DATA-BY-IDENTIFIER-CLASS">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DIAGNOSTIC-WRITE-DATA-BY-IDENTIFIER-CLASS"/>
 *       &lt;/sequence>
...
@XmlType(name = "DIAGNOSTIC-WRITE-DATA-BY-IDENTIFIER-CLASS", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class DIAGNOSTICWRITEDATABYIDENTIFIERCLASS {
    ...
    protected DIAGNOSTICWRITEDATABYIDENTIFIERCLASS.ACCESSPERMISSIONREF accesspermissionref;
     ...
     * @return
     *     possible object is
     *     {@link DIAGNOSTICWRITEDATABYIDENTIFIERCLASS.ACCESSPERMISSIONREF }
     *     
     */
    public DIAGNOSTICWRITEDATABYIDENTIFIERCLASS.ACCESSPERMISSIONREF getACCESSPERMISSIONREF() {
     ...
     *     
     */
    public void setACCESSPERMISSIONREF(DIAGNOSTICWRITEDATABYIDENTIFIERCLASS.ACCESSPERMISSIONREF value) {
     ...
     *       &lt;attribute name="DEST" use="required" type="{http://autosar.org/schema/r4.0}DIAGNOSTIC-ACCESS-PERMISSION--SUBTYPES-ENUM" />
     *     &lt;/extension>
     *   &lt;/simpleContent>
     * &lt;/complexType>
     * </pre>
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class ACCESSPERMISSIONREF
        extends REF
    {
         ...
         * @return
         *     possible object is
         *     {@link DIAGNOSTICACCESSPERMISSIONSUBTYPESENUM }
         *     
         */
