...
/**
 * <p>BUILD-ACTION--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="BUILD-ACTION--SUBTYPES-ENUM">
...
public enum BUILDACTIONSUBTYPESENUM {
    ...
    BUILDACTIONSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static BUILDACTIONSUBTYPESENUM fromValue(String v) {
