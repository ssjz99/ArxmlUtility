 ...
 * 
 * <p>TD-EVENT-TRIGGER complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="TD-EVENT-TRIGGER">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}TD-EVENT-TRIGGER"/>
 *       &lt;/sequence>
...
@XmlType(name = "TD-EVENT-TRIGGER", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class TDEVENTTRIGGER {
    ...
    protected TDEVENTTRIGGER.TRIGGERREF triggerref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link TDEVENTTRIGGERTYPEENUM }
     *     
     */
    public TDEVENTTRIGGERTYPEENUM getTDEVENTTRIGGERTYPE() {
        return tdeventtriggertype;
    }
     ...
     * @return
     *     possible object is
     *     {@link TDEVENTTRIGGER.TRIGGERREF }
     *     
     */
    public TDEVENTTRIGGER.TRIGGERREF getTRIGGERREF() {
        return triggerref;
    }
     ...
     *     
     */
    public void setTRIGGERREF(TDEVENTTRIGGER.TRIGGERREF value) {
