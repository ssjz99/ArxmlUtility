 ...
 * 
 * <p>DIAGNOSTIC-WRITE-MEMORY-BY-ADDRESS-CLASS complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAGNOSTIC-WRITE-MEMORY-BY-ADDRESS-CLASS">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DIAGNOSTIC-WRITE-MEMORY-BY-ADDRESS-CLASS"/>
 *       &lt;/sequence>
...
@XmlType(name = "DIAGNOSTIC-WRITE-MEMORY-BY-ADDRESS-CLASS", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
