 ...
 * 
 * <p>TD-EVENT-SWC-INTERNAL-BEHAVIOR-REFERENCE complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="TD-EVENT-SWC-INTERNAL-BEHAVIOR-REFERENCE">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}TD-EVENT-SWC-INTERNAL-BEHAVIOR-REFERENCE"/>
 *       &lt;/sequence>
...
@XmlType(name = "TD-EVENT-SWC-INTERNAL-BEHAVIOR-REFERENCE", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class TDEVENTSWCINTERNALBEHAVIORREFERENCE {
    ...
    protected TDEVENTSWCINTERNALBEHAVIORREFERENCE.REFERENCEDTDEVENTSWCREF referencedtdeventswcref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link TDEVENTSWCINTERNALBEHAVIORREFERENCE.REFERENCEDTDEVENTSWCREF }
     *     
     */
    public TDEVENTSWCINTERNALBEHAVIORREFERENCE.REFERENCEDTDEVENTSWCREF getREFERENCEDTDEVENTSWCREF() {
        return referencedtdeventswcref;
    }
     ...
     *     
     */
    public void setREFERENCEDTDEVENTSWCREF(TDEVENTSWCINTERNALBEHAVIORREFERENCE.REFERENCEDTDEVENTSWCREF value) {
     ...
     *       &lt;attribute name="DEST" use="required" type="{http://autosar.org/schema/r4.0}TD-EVENT-SWC--SUBTYPES-ENUM" />
     *     &lt;/extension>
     *   &lt;/simpleContent>
     * &lt;/complexType>
     * </pre>
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class REFERENCEDTDEVENTSWCREF
        extends REF
    {
