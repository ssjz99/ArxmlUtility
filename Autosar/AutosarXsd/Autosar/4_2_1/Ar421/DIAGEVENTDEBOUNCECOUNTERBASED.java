 ...
 * 
 * <p>DIAG-EVENT-DEBOUNCE-COUNTER-BASED complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAG-EVENT-DEBOUNCE-COUNTER-BASED">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DIAG-EVENT-DEBOUNCE-ALGORITHM"/>
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DIAG-EVENT-DEBOUNCE-COUNTER-BASED"/>
 *       &lt;/sequence>
...
@XmlType(name = "DIAG-EVENT-DEBOUNCE-COUNTER-BASED", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class DIAGEVENTDEBOUNCECOUNTERBASED {
    ...
    public INTEGER getCOUNTERDECREMENTSTEPSIZE() {
        return counterdecrementstepsize;
    }
    ...
    public INTEGER getCOUNTERINCREMENTSTEPSIZE() {
        return counterincrementstepsize;
    }
