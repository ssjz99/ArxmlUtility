...
/**
 * <p>DIAGNOSTIC-SERVICE-TABLE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-SERVICE-TABLE--SUBTYPES-ENUM">
...
public enum DIAGNOSTICSERVICETABLESUBTYPESENUM {
    ...
    DIAGNOSTICSERVICETABLESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICSERVICETABLESUBTYPESENUM fromValue(String v) {
