...
/**
 * <p>POST-BUILD-VARIANT-CRITERION--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="POST-BUILD-VARIANT-CRITERION--SUBTYPES-ENUM">
...
public enum POSTBUILDVARIANTCRITERIONSUBTYPESENUM {
    ...
    POSTBUILDVARIANTCRITERIONSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static POSTBUILDVARIANTCRITERIONSUBTYPESENUM fromValue(String v) {
