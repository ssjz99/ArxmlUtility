...
/**
 * <p>SW-AXIS-TYPE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="SW-AXIS-TYPE--SUBTYPES-ENUM">
...
public enum SWAXISTYPESUBTYPESENUM {
    ...
    SWAXISTYPESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static SWAXISTYPESUBTYPESENUM fromValue(String v) {
