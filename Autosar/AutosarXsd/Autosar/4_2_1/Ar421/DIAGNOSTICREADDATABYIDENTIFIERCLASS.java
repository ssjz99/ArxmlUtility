 ...
 * 
 * <p>DIAGNOSTIC-READ-DATA-BY-IDENTIFIER-CLASS complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAGNOSTIC-READ-DATA-BY-IDENTIFIER-CLASS">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DIAGNOSTIC-READ-DATA-BY-IDENTIFIER-CLASS"/>
 *       &lt;/sequence>
...
@XmlType(name = "DIAGNOSTIC-READ-DATA-BY-IDENTIFIER-CLASS", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
