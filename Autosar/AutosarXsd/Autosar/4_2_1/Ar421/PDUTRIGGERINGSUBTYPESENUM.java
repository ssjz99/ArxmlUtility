...
/**
 * <p>PDU-TRIGGERING--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="PDU-TRIGGERING--SUBTYPES-ENUM">
...
public enum PDUTRIGGERINGSUBTYPESENUM {
    ...
    PDUTRIGGERINGSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static PDUTRIGGERINGSUBTYPESENUM fromValue(String v) {
