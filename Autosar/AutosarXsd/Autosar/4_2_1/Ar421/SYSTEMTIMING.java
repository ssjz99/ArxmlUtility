 ...
 * 
 * <p>SYSTEM-TIMING complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="SYSTEM-TIMING">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}SYSTEM-TIMING"/>
 *       &lt;/sequence>
...
@XmlType(name = "SYSTEM-TIMING", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class SYSTEMTIMING {
    ...
    protected SYSTEMTIMING.SYSTEMREF systemref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link SYSTEMTIMING.SYSTEMREF }
     *     
     */
    public SYSTEMTIMING.SYSTEMREF getSYSTEMREF() {
        return systemref;
    }
     ...
     *     
     */
    public void setSYSTEMREF(SYSTEMTIMING.SYSTEMREF value) {
