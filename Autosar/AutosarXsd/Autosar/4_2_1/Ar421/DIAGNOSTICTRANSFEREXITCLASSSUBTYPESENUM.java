...
/**
 * <p>DIAGNOSTIC-TRANSFER-EXIT-CLASS--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-TRANSFER-EXIT-CLASS--SUBTYPES-ENUM">
...
public enum DIAGNOSTICTRANSFEREXITCLASSSUBTYPESENUM {
    ...
    DIAGNOSTICTRANSFEREXITCLASSSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICTRANSFEREXITCLASSSUBTYPESENUM fromValue(String v) {
