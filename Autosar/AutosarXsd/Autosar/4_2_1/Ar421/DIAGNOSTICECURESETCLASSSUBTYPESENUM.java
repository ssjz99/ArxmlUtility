...
/**
 * <p>DIAGNOSTIC-ECU-RESET-CLASS--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-ECU-RESET-CLASS--SUBTYPES-ENUM">
...
public enum DIAGNOSTICECURESETCLASSSUBTYPESENUM {
    ...
    DIAGNOSTICECURESETCLASSSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICECURESETCLASSSUBTYPESENUM fromValue(String v) {
