 ...
 * 
 * <p>BSW-EXTERNAL-TRIGGER-OCCURRED-EVENT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="BSW-EXTERNAL-TRIGGER-OCCURRED-EVENT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}BSW-EXTERNAL-TRIGGER-OCCURRED-EVENT"/>
 *       &lt;/sequence>
...
@XmlType(name = "BSW-EXTERNAL-TRIGGER-OCCURRED-EVENT", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class BSWEXTERNALTRIGGEROCCURREDEVENT {
    ...
    protected BSWEXTERNALTRIGGEROCCURREDEVENT.TRIGGERREF triggerref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link BSWEXTERNALTRIGGEROCCURREDEVENT.TRIGGERREF }
     *     
     */
    public BSWEXTERNALTRIGGEROCCURREDEVENT.TRIGGERREF getTRIGGERREF() {
        return triggerref;
    }
     ...
     *     
     */
    public void setTRIGGERREF(BSWEXTERNALTRIGGEROCCURREDEVENT.TRIGGERREF value) {
