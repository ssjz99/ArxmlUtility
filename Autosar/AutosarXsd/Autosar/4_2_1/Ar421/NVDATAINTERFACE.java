 ...
 * 
 * <p>NV-DATA-INTERFACE complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="NV-DATA-INTERFACE">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}NV-DATA-INTERFACE"/>
 *       &lt;/sequence>
...
@XmlType(name = "NV-DATA-INTERFACE", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class NVDATAINTERFACE {
    ...
    protected NVDATAINTERFACE.NVDATAS nvdatas;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link NVDATAINTERFACE.NVDATAS }
     *     
     */
    public NVDATAINTERFACE.NVDATAS getNVDATAS() {
        return nvdatas;
    }
     ...
     *     
     */
    public void setNVDATAS(NVDATAINTERFACE.NVDATAS value) {
        this.nvdatas = value;
    }
