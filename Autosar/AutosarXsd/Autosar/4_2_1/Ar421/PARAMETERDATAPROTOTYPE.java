 ...
 * 
 * <p>PARAMETER-DATA-PROTOTYPE complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="PARAMETER-DATA-PROTOTYPE">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}PARAMETER-DATA-PROTOTYPE"/>
 *       &lt;/sequence>
...
@XmlType(name = "PARAMETER-DATA-PROTOTYPE", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class PARAMETERDATAPROTOTYPE {
    ...
    protected PARAMETERDATAPROTOTYPE.INITVALUE initvalue;
     ...
     * @return
     *     possible object is
     *     {@link PARAMETERDATAPROTOTYPE.INITVALUE }
     *     
     */
    public PARAMETERDATAPROTOTYPE.INITVALUE getINITVALUE() {
        return initvalue;
    }
     ...
     *     
     */
    public void setINITVALUE(PARAMETERDATAPROTOTYPE.INITVALUE value) {
