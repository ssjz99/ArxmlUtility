 ...
 * 
 * <p>SENSOR-ACTUATOR-SW-COMPONENT-TYPE complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="SENSOR-ACTUATOR-SW-COMPONENT-TYPE">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}SENSOR-ACTUATOR-SW-COMPONENT-TYPE"/>
 *       &lt;/sequence>
...
@XmlType(name = "SENSOR-ACTUATOR-SW-COMPONENT-TYPE", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class SENSORACTUATORSWCOMPONENTTYPE {
    ...
    protected SENSORACTUATORSWCOMPONENTTYPE.SENSORACTUATORREF sensoractuatorref;
     ...
     * @return
     *     possible object is
     *     {@link SENSORACTUATORSWCOMPONENTTYPE.SENSORACTUATORREF }
     *     
     */
    public SENSORACTUATORSWCOMPONENTTYPE.SENSORACTUATORREF getSENSORACTUATORREF() {
        return sensoractuatorref;
    }
     ...
     *     
     */
    public void setSENSORACTUATORREF(SENSORACTUATORSWCOMPONENTTYPE.SENSORACTUATORREF value) {
    ...
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "")
    public static class SENSORACTUATORREF
        extends REF
    {
