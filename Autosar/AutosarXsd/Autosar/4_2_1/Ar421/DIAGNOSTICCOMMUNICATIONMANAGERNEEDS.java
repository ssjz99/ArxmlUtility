 ...
 * 
 * <p>DIAGNOSTIC-COMMUNICATION-MANAGER-NEEDS complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAGNOSTIC-COMMUNICATION-MANAGER-NEEDS">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DIAGNOSTIC-COMMUNICATION-MANAGER-NEEDS"/>
 *       &lt;/sequence>
...
@XmlType(name = "DIAGNOSTIC-COMMUNICATION-MANAGER-NEEDS", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class DIAGNOSTICCOMMUNICATIONMANAGERNEEDS {
     ...
     * @return
     *     possible object is
     *     {@link DIAGNOSTICSERVICEREQUESTCALLBACKTYPEENUM }
     *     
     */
    public DIAGNOSTICSERVICEREQUESTCALLBACKTYPEENUM getSERVICEREQUESTCALLBACKTYPE() {
        return servicerequestcallbacktype;
    }
