...
/**
 * <p>DATA-PROTOTYPE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DATA-PROTOTYPE--SUBTYPES-ENUM">
...
public enum DATAPROTOTYPESUBTYPESENUM {
    ...
    DATAPROTOTYPESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DATAPROTOTYPESUBTYPESENUM fromValue(String v) {
