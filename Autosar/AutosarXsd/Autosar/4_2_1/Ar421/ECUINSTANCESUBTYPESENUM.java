...
/**
 * <p>ECU-INSTANCE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="ECU-INSTANCE--SUBTYPES-ENUM">
...
public enum ECUINSTANCESUBTYPESENUM {
    ...
    ECUINSTANCESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static ECUINSTANCESUBTYPESENUM fromValue(String v) {
