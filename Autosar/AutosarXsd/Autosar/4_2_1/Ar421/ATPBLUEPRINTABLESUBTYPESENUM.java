...
/**
 * <p>ATP-BLUEPRINTABLE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="ATP-BLUEPRINTABLE--SUBTYPES-ENUM">
...
public enum ATPBLUEPRINTABLESUBTYPESENUM {
    ...
    ATPBLUEPRINTABLESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static ATPBLUEPRINTABLESUBTYPESENUM fromValue(String v) {
