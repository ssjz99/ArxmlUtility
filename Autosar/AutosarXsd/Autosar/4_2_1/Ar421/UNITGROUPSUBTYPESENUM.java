...
/**
 * <p>UNIT-GROUP--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="UNIT-GROUP--SUBTYPES-ENUM">
...
public enum UNITGROUPSUBTYPESENUM {
    ...
    UNITGROUPSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static UNITGROUPSUBTYPESENUM fromValue(String v) {
