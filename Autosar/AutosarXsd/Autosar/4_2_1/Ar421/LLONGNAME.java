 ...
 * 
 * <p>L-LONG-NAME complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="L-LONG-NAME">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}L-LONG-NAME"/>
 *       &lt;/choice>
...
@XmlType(name = "L-LONG-NAME", propOrder = {
    "content"
})
public class LLONGNAME {
    ...
    /**
     * MixedContentForLongNames  in one particular language. The language is denoted in the attribute l.Gets the value of the content property.
     * 
     * <p>
