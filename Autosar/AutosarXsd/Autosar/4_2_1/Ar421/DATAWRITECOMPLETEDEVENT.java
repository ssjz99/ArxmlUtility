 ...
 * 
 * <p>DATA-WRITE-COMPLETED-EVENT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DATA-WRITE-COMPLETED-EVENT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DATA-WRITE-COMPLETED-EVENT"/>
 *       &lt;/sequence>
...
@XmlType(name = "DATA-WRITE-COMPLETED-EVENT", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class DATAWRITECOMPLETEDEVENT {
    ...
    protected DATAWRITECOMPLETEDEVENT.EVENTSOURCEREF eventsourceref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link DATAWRITECOMPLETEDEVENT.EVENTSOURCEREF }
     *     
     */
    public DATAWRITECOMPLETEDEVENT.EVENTSOURCEREF getEVENTSOURCEREF() {
     ...
     *     
     */
    public void setEVENTSOURCEREF(DATAWRITECOMPLETEDEVENT.EVENTSOURCEREF value) {
