...
/**
 * <p>ECUC-DEFINITION-ELEMENT--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="ECUC-DEFINITION-ELEMENT--SUBTYPES-ENUM">
...
public enum ECUCDEFINITIONELEMENTSUBTYPESENUM {
    ...
    ECUCDEFINITIONELEMENTSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static ECUCDEFINITIONELEMENTSUBTYPESENUM fromValue(String v) {
