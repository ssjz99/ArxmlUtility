 ...
 * 
 * <p>ASYNCHRONOUS-SERVER-CALL-RETURNS-EVENT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="ASYNCHRONOUS-SERVER-CALL-RETURNS-EVENT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}ASYNCHRONOUS-SERVER-CALL-RETURNS-EVENT"/>
 *       &lt;/sequence>
...
@XmlType(name = "ASYNCHRONOUS-SERVER-CALL-RETURNS-EVENT", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class ASYNCHRONOUSSERVERCALLRETURNSEVENT {
    ...
    protected ASYNCHRONOUSSERVERCALLRETURNSEVENT.EVENTSOURCEREF eventsourceref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link ASYNCHRONOUSSERVERCALLRETURNSEVENT.EVENTSOURCEREF }
     *     
     */
    public ASYNCHRONOUSSERVERCALLRETURNSEVENT.EVENTSOURCEREF getEVENTSOURCEREF() {
     ...
     *     
     */
    public void setEVENTSOURCEREF(ASYNCHRONOUSSERVERCALLRETURNSEVENT.EVENTSOURCEREF value) {
     ...
     *       &lt;attribute name="DEST" use="required" type="{http://autosar.org/schema/r4.0}ASYNCHRONOUS-SERVER-CALL-RESULT-POINT--SUBTYPES-ENUM" />
     *     &lt;/extension>
     *   &lt;/simpleContent>
     * &lt;/complexType>
     * </pre>
        ...
        extends REF
    {
         ...
         * @return
         *     possible object is
         *     {@link ASYNCHRONOUSSERVERCALLRESULTPOINTSUBTYPESENUM }
         *     
         */
