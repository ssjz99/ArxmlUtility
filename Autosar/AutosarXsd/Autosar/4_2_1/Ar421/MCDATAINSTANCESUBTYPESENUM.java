...
/**
 * <p>MC-DATA-INSTANCE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="MC-DATA-INSTANCE--SUBTYPES-ENUM">
...
public enum MCDATAINSTANCESUBTYPESENUM {
    ...
    MCDATAINSTANCESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static MCDATAINSTANCESUBTYPESENUM fromValue(String v) {
