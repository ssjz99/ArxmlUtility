...
/**
 * <p>SW-COMPONENT-TYPE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="SW-COMPONENT-TYPE--SUBTYPES-ENUM">
...
public enum SWCOMPONENTTYPESUBTYPESENUM {
    ...
    SWCOMPONENTTYPESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static SWCOMPONENTTYPESUBTYPESENUM fromValue(String v) {
