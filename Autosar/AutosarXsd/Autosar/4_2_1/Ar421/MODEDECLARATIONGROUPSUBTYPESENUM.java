...
/**
 * <p>MODE-DECLARATION-GROUP--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="MODE-DECLARATION-GROUP--SUBTYPES-ENUM">
...
public enum MODEDECLARATIONGROUPSUBTYPESENUM {
    ...
    MODEDECLARATIONGROUPSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static MODEDECLARATIONGROUPSUBTYPESENUM fromValue(String v) {
