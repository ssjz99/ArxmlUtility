 ...
 * 
 * <p>GLOBAL-TIME-CRC-SUPPORT-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="GLOBAL-TIME-CRC-SUPPORT-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>GLOBAL-TIME-CRC-SUPPORT-ENUM--SIMPLE">
...
@XmlType(name = "GLOBAL-TIME-CRC-SUPPORT-ENUM", propOrder = {
    "value"
})
public class GLOBALTIMECRCSUPPORTENUM {
     ...
     * @return
     *     possible object is
     *     {@link GLOBALTIMECRCSUPPORTENUMSIMPLE }
     *     
     */
