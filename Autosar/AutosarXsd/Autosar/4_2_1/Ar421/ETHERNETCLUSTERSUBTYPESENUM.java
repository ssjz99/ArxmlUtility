...
/**
 * <p>ETHERNET-CLUSTER--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="ETHERNET-CLUSTER--SUBTYPES-ENUM">
...
public enum ETHERNETCLUSTERSUBTYPESENUM {
    ...
    ETHERNETCLUSTERSUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static ETHERNETCLUSTERSUBTYPESENUM fromValue(String v) {
