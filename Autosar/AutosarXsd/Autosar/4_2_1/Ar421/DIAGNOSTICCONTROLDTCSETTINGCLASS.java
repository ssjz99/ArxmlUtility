 ...
 * 
 * <p>DIAGNOSTIC-CONTROL-DTC-SETTING-CLASS complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAGNOSTIC-CONTROL-DTC-SETTING-CLASS">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}DIAGNOSTIC-CONTROL-DTC-SETTING-CLASS"/>
 *       &lt;/sequence>
...
@XmlType(name = "DIAGNOSTIC-CONTROL-DTC-SETTING-CLASS", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class DIAGNOSTICCONTROLDTCSETTINGCLASS {
    ...
    public BOOLEAN getCONTROLOPTIONRECORDPRESENT() {
        return controloptionrecordpresent;
    }
