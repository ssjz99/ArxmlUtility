 ...
 * 
 * <p>EVENT-ACCEPTANCE-STATUS-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="EVENT-ACCEPTANCE-STATUS-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>EVENT-ACCEPTANCE-STATUS-ENUM--SIMPLE">
...
@XmlType(name = "EVENT-ACCEPTANCE-STATUS-ENUM", propOrder = {
    "value"
})
public class EVENTACCEPTANCESTATUSENUM {
     ...
     * @return
     *     possible object is
     *     {@link EVENTACCEPTANCESTATUSENUMSIMPLE }
     *     
     */
