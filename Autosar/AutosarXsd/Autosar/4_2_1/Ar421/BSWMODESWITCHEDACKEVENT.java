 ...
 * 
 * <p>BSW-MODE-SWITCHED-ACK-EVENT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="BSW-MODE-SWITCHED-ACK-EVENT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}BSW-MODE-SWITCHED-ACK-EVENT"/>
 *       &lt;/sequence>
...
@XmlType(name = "BSW-MODE-SWITCHED-ACK-EVENT", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class BSWMODESWITCHEDACKEVENT {
    ...
    protected BSWMODESWITCHEDACKEVENT.MODEGROUPREF modegroupref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link BSWMODESWITCHEDACKEVENT.MODEGROUPREF }
     *     
     */
    public BSWMODESWITCHEDACKEVENT.MODEGROUPREF getMODEGROUPREF() {
        return modegroupref;
    }
     ...
     *     
     */
    public void setMODEGROUPREF(BSWMODESWITCHEDACKEVENT.MODEGROUPREF value) {
