 ...
 * 
 * <p>ECUC-URI-REFERENCE-DEF complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="ECUC-URI-REFERENCE-DEF">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}ECUC-URI-REFERENCE-DEF"/>
 *       &lt;/sequence>
...
@XmlType(name = "ECUC-URI-REFERENCE-DEF", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class ECUCURIREFERENCEDEF {
    ...
    protected ECUCURIREFERENCEDEF.DESTINATIONURIREF destinationuriref;
    @XmlAttribute(name = "S")
    protected String s;
    @XmlAttribute(name = "T")
    protected String t;
     ...
     * @return
     *     possible object is
     *     {@link ECUCURIREFERENCEDEF.DESTINATIONURIREF }
     *     
     */
    public ECUCURIREFERENCEDEF.DESTINATIONURIREF getDESTINATIONURIREF() {
        return destinationuriref;
    }
     ...
     *     
     */
    public void setDESTINATIONURIREF(ECUCURIREFERENCEDEF.DESTINATIONURIREF value) {
