...
/**
 * <p>DIAGNOSTIC-OPERATION-CYCLE--SUBTYPES-ENUM? Java ??
 * 
 * <p>????????????????????
 * <p>
 * <pre>
 * &lt;simpleType name="DIAGNOSTIC-OPERATION-CYCLE--SUBTYPES-ENUM">
...
public enum DIAGNOSTICOPERATIONCYCLESUBTYPESENUM {
    ...
    DIAGNOSTICOPERATIONCYCLESUBTYPESENUM(String v) {
        value = v;
    }
    ...
    public static DIAGNOSTICOPERATIONCYCLESUBTYPESENUM fromValue(String v) {
