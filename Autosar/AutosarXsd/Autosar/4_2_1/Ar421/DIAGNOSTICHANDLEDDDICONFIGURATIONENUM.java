 ...
 * 
 * <p>DIAGNOSTIC-HANDLE-DDDI-CONFIGURATION-ENUM complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="DIAGNOSTIC-HANDLE-DDDI-CONFIGURATION-ENUM">
 *   &lt;simpleContent>
 *     &lt;extension base="&lt;http://autosar.org/schema/r4.0>DIAGNOSTIC-HANDLE-DDDI-CONFIGURATION-ENUM--SIMPLE">
...
@XmlType(name = "DIAGNOSTIC-HANDLE-DDDI-CONFIGURATION-ENUM", propOrder = {
    "value"
})
public class DIAGNOSTICHANDLEDDDICONFIGURATIONENUM {
     ...
     * @return
     *     possible object is
     *     {@link DIAGNOSTICHANDLEDDDICONFIGURATIONENUMSIMPLE }
     *     
     */
