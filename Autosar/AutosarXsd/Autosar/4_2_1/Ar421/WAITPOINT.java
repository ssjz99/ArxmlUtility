 ...
 * 
 * <p>WAIT-POINT complex type? Java ??
 * 
 * <p>????????????????????
 * 
 * <pre>
 * &lt;complexType name="WAIT-POINT">
 *   &lt;complexContent>
 ...
 *         &lt;group ref="{http://autosar.org/schema/r4.0}WAIT-POINT"/>
 *       &lt;/sequence>
...
@XmlType(name = "WAIT-POINT", propOrder = {
    "shortname",
    "longname",
    "desc",
    "category",
...
public class WAITPOINT {
    ...
    protected WAITPOINT.TRIGGERREF triggerref;
     ...
     * @return
     *     possible object is
     *     {@link WAITPOINT.TRIGGERREF }
     *     
     */
    public WAITPOINT.TRIGGERREF getTRIGGERREF() {
        return triggerref;
    }
     ...
     *     
     */
    public void setTRIGGERREF(WAITPOINT.TRIGGERREF value) {
